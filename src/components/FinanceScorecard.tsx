...
function Card({ title, value, change, isPercentage = false, icon, iconBg, subtitle }: CardProps) {
  ...
  return (
    <div className="metric-card">
      ...
      {change !== 0 ? (
        ...
        <p className="metric-card-subtitle text-gray-400">{subtitle || 'Todos los eventos'}</p>
      )}
...
export default function FinanceScorecard({
  ...
  const subtitle = eventName || undefined;
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      <Card
        ...
        iconBg="bg-emerald-100" subtitle={subtitle}
        icon={
      ...
      <Card
        ...
        change={aovChange}
        iconBg="bg-blue-100" subtitle={subtitle}
        icon={
      ...
      <Card
        ...
        change={ordersChange}
        iconBg="bg-purple-100" subtitle={subtitle}
        icon={
      ...
      <Card
        ...
        isPercentage
        iconBg="bg-amber-100" subtitle={subtitle}
        icon={
